...
const FilterBar = () => {
  //Bu bölümdeki butonların ve select menüsünün işlevselliği daha sonraki adımlarda ekle!!!!!!
  // Şimdilik sadece görsel yapı.
  return (
    <div className="container mx-auto mb-8">
      <div className="flex flex-wrap justify-between items-center bg-[#FAFAFA] p-6 rounded">
